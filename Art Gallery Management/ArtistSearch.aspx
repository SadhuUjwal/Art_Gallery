...
<head runat="server">
	...
	height:100%;
	margin:0px;padding:0px;
}.vzzx tr:last-child td:last-child {
	-moz-border-radius-bottomright:17px;
	-webkit-border-bottom-right-radius:17px;
	border-bottom-right-radius:17px;
}
.vzzx table tr:first-child td:first-child {
	-moz-border-radius-topleft:17px;
	-webkit-border-top-left-radius:17px;
	border-top-left-radius:17px;
}
.vzzx table tr:first-child td:last-child {
	-moz-border-radius-topright:17px;
	-webkit-border-top-right-radius:17px;
	border-top-right-radius:17px;
}.vzzx tr:last-child td:first-child{
	-moz-border-radius-bottomleft:17px;
	-webkit-border-bottom-left-radius:17px;
	border-bottom-left-radius:17px;
}.vzzx tr:hover td{
...
.vzzx td{
	...
	font-weight:bold;
	color:#000000;
}.vzzx tr:last-child td{
	border-width:0px 1px 0px 0px;
}.vzzx tr td:last-child{
	border-width:0px 0px 1px 0px;
}.vzzx tr:last-child td:last-child{
	border-width:0px 0px 0px 0px;
}
.vzzx tr:first-child td{
...
.vzzx tr:first-child td:first-child{
	border-width:0px 0px 1px 0px;
}
.vzzx tr:first-child td:last-child{
	border-width:0px 0px 1px 1px;
}</style>
</head>
<body>
    ...
    <div>
     <table class="vzzx" style="position:absolute; top: 465px; left: 203px; width: 902px; height: 197px; ">
                    <tr>
                    ...
                    <marquee scrollamount="5" width="40" class="style5">&lt;&lt;&lt;</marquee><span 
                            class="style5"><strong>LIST OF AVAILABLE ARTIST<marquee scrollamount="5" direction="right" width="40">&gt;&gt;&gt;</marquee></strong></span></span><br />
                ...
                <td class="style7">
                    &nbsp;</td>
                            ...
                            <tr>
                               ...
                               <marquee behavior="alternate"><marquee width="200"> LIST OF AVAILABLE ARTIST</marquee></marquee>
                               </td>
                               <td class="style7">
                  ...
                  <asp:GridView ID="GridView1" runat="server" 
                                       style="position:absolute; top: 214px; left: 55px; width: 797px;" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                        <asp:BoundField DataField="ArtistId" HeaderText="ArtistId" InsertVisible="False" 
                    ReadOnly="True" SortExpression="ArtistId" />

                              <asp:BoundField DataField="Artname" HeaderText="Artname" InsertVisible="true" ReadOnly="True" SortExpression="Artname" />

                                        <%--    <asp:BoundField DataField="city" HeaderText="City" SortExpression="city" />--%>
                                            <asp:BoundField DataField="Yearcreated" HeaderText="Yearcreated" SortExpression="Yearcreated" />
