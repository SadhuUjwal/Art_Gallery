<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gallery Upload.aspx.cs" Inherits="Gallery_Upload" %>
    ...
    <table class="aa"
        ...
        <tr><td colspan="2">Gallery Upload</td></tr>
            <tr>
                ...
                <td class="style5">
                    <asp:Label ID="Label9" runat="server" CssClass="style3" Text="Label"></asp:Label>
                </td>
            </tr>
        <tr><td>
            ...
            <tr>
                ...
                <td class="style4">
                    <asp:Label ID="Label2" runat="server" Text="Country" CssClass="style2"></asp:Label>
                </td>
                <td class="style5">
            ...
            <tr>
                <td class="style4">
                    <asp:Label ID="Label8" runat="server" Text="Zip" CssClass="style2"></asp:Label>
                </td>
                <td class="style5">
